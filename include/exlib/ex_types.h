...
#else
    #ifdef __cplusplus
        /* For Visual Studio 6 in C++ mode and for many Visual Studio versions
         * when compiling for ARM we should wrap <wchar.h> include with
         * 'extern "C++" {}' or compiler give many errors like this:
